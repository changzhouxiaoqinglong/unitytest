...
Shader "Code Animo/Surface Waves/BasicWaterSurface" {
	Properties {
...
//==============Surface Shader====================
		...
		void surf (Input IN, inout SurfaceOutput o) {
			...
			o.Emission = lerp(float3(0,0,0), reflection, fresnel).rgb;// Mix over and underwater effects
			o.Albedo = lerp(_FogDiffuseColor, float3(0,0,0), fresnel).rgb;
